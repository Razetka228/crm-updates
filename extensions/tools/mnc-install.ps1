# CRM extension auto-update INSTALLER (MNC direction). Run ONCE per machine.
#   powershell -NoProfile -ExecutionPolicy Bypass -File mnc-install.ps1
#
...
$ExtDir      = Join-Path $Base 'mnc'
$UpdaterPath = Join-Path $Base 'mnc-updater.ps1'
$UpdaterUrl  = 'https://raw.githubusercontent.com/Razetka228/crm-updates/main/extensions/tools/mnc-updater.ps1'
$VbsPath     = Join-Path $Base 'mnc-run-hidden.vbs'
$VbsUrl      = 'https://raw.githubusercontent.com/Razetka228/crm-updates/main/extensions/tools/mnc-run-hidden.vbs'
$TaskName    = 'CRM Ext Auto-Update MNC'
$IntervalMin = 3
