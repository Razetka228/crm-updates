# CRM extension auto-updater (MNC direction).
...
# === CONFIG ===
$ExtDir            = Join-Path $env:LOCALAPPDATA 'crm-ext\mnc'
$RepoZipUrl        = 'https://codeload.github.com/Razetka228/crm-updates/zip/refs/heads/main'
$RepoSubPath       = 'crm-updates-main\extensions\mnc'
$RemoteManifestUrl = 'https://raw.githubusercontent.com/Razetka228/crm-updates/main/extensions/mnc/manifest.json'
