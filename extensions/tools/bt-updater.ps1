# CRM extension auto-updater (BT direction).
...
# === CONFIG ===
$ExtDir            = Join-Path $env:LOCALAPPDATA 'crm-ext\bt'
$RepoZipUrl        = 'https://codeload.github.com/Razetka228/crm-updates/zip/refs/heads/main'
$RepoSubPath       = 'crm-updates-main\extensions\bt'
$RemoteManifestUrl = 'https://raw.githubusercontent.com/Razetka228/crm-updates/main/extensions/bt/manifest.json'
