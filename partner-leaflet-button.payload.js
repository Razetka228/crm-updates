// Payload: логика кнопки "партнёр/листовка".
// Загружается loader-скриптом с GitHub при каждой загрузке страницы.
// GM_setClipboard приходит параметром из loader (см. loader).
(function() {
    'use strict';
